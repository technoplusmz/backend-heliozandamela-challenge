...
import static mz.co.exchange.api.user.domain.query.UserSpecification.findByName;
import static mz.co.exchange.api.user.domain.query.UserSpecification.findByUserName;
